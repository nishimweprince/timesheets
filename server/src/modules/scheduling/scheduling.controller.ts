...
export class SchedulingController {
  ...
  findPatterns(@CurrentUser() user: RequestUser, @Query() query: ListSchedulingQueryDto) {
  ...
  createPattern(@CurrentUser() user: RequestUser, @Body() dto: CreateShiftPatternDto) {
  ...
  archivePattern(@CurrentUser() user: RequestUser, @Param('id', new ParseUUIDPipe()) id: string) {
  ...
  cancelInstance(@CurrentUser() user: RequestUser, @Param('id', new ParseUUIDPipe()) id: string) {
